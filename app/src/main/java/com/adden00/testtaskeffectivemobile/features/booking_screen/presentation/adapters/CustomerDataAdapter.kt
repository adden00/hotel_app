...
import com.adden00.testtaskeffectivemobile.databinding.BookingTouristItemBinding
    ...
    inner class ItemHolder(private val binding: BookingTouristItemBinding) :
        ...
        fun render(item: CustomerDataDelegateItem) {
            if (item.touristNum != -1)
                binding.tvTouristNumber.text = "${item.touristNum} турист"
            else
                binding.tvTouristNumber.text = "Добавить туриста"
